...
private:
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("C:/Users/Denisa/Desktop/TinyVulcanoEngine/resources/textures/statue.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
